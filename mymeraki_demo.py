...
<div style="background-color: #fff8dc; padding: 10px; border: 1px solid #ddd; border-radius: 5px; margin-top: 15px;">
    <strong>Note:</strong> This is just a basic demo layout to test the technicals, knowledge and query handling capabilities, of Meraki AI. The final visual layout will not look like this. Specific information about products can also be added later on.
</div>
""", unsafe_allow_html=True)
